            ...
            <div className="flex items-center gap-3">
              {isAuthenticated ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => logout()}
                    className="text-xs font-semibold text-slate-600 hover:text-red-600 px-2.5 py-1.5 rounded-lg border border-slate-200 hover:border-red-200 hover:bg-red-50 transition-colors"
                  >
                    Sign Out
                  </button>
                </div>
                ...
                <button
                  ...
                  className="px-4 py-2 bg-sanchay-navy-700 hover:bg-sanchay-navy-800 text-white text-xs font-bold rounded-xl shadow-xs transition-colors"
                >
                  Sign In
                </button>
              )}
